...
const Cash = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // On n'appelle l'historique que pour l'admin
      if (isAdmin) {
  ...
  if (error) return (
    <div className="p-8 text-center">
        <div className="bg-red-50 text-red-600 p-6 rounded-2xl border-2 border-red-100 inline-block max-w-md">
            ...
            <button 
                onClick={fetchData}
                className="px-6 py-2 bg-red-600 text-zinc-900 dark:text-white rounded-xl font-black hover:bg-red-700 transition-colors"
            >
                RÉESSAYER
            </button>
        </div>
  ...
  return (
    <div className="space-y-6">
        ...
        {isAdmin && (
            <div className="flex bg-white dark:bg-zinc-900 rounded-xl shadow-lg border border-zinc-800 p-1 w-full sm:w-auto">
                <button 
                    ...
                    className={`flex-1 sm:flex-none px-6 py-2 rounded-lg font-black text-[10px] sm:text-xs uppercase transition-all ${activeTab === 'current' ? 'bg-gold text-rich-black shadow-md' : 'text-zinc-500 hover:bg-zinc-100 dark:bg-zinc-800'}`}
                >
                    Aujourd'hui
                </button>
                <button 
      ...
      {activeTab === 'current' ? (
        ...
        {isAdmin ? (
          <>
            <div className="bg-white dark:bg-zinc-900 p-6 rounded-2xl shadow-xl border border-gold/10 relative overflow-hidden group">
          ...
          <div className="sm:col-span-2 bg-white dark:bg-zinc-900/50 p-6 rounded-2xl border border-gold/5 flex items-center justify-center">
            <p className="text-zinc-500 font-bold italic text-sm">Session de travail active - Enregistrez vos dépenses ci-dessous.</p>
          </div>
        )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Expenses Table */}
        <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-gold/10 overflow-hidden">
            <div className="p-6 border-b border-zinc-800 flex justify-between items-center bg-zinc-100 dark:bg-zinc-800/50">
                    ...
                    <tbody className="divide-y divide-zinc-800 text-zinc-300">
                        {expenses.length === 0 ? (
                            ...
                            expenses.map((exp, idx) => (
                                <tr key={idx} className="hover:bg-zinc-100 dark:bg-zinc-800/50 transition-colors">
        ...
        {isAdmin && (
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-gold/10 p-8 space-y-6 flex flex-col justify-center relative">
                ...
                <div className="space-y-4 border-y-2 border-dashed border-zinc-800 py-8">
                    <div className="flex justify-between items-center">
                        ...
                        <span className="font-black text-zinc-900 dark:text-white text-lg">{dailyCash.initialCash} DA</span>
                    </div>
                    <div className="flex justify-between items-center">
                ...
                <div className="flex justify-between items-center pt-6">
                    <span className="text-lg font-black text-zinc-900 dark:text-white uppercase tracking-widest font-luxury">SOLDE FINAL</span>
        ...
        <div className="space-y-6">
            <div className="bg-white dark:bg-zinc-900 p-4 rounded-xl shadow-xl border border-zinc-800 flex flex-wrap gap-4 items-end">
                <div className="flex-1 min-w-[300px]">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="relative flex-1">
                            ...
                            <input 
                            type="date" 
                            className="w-full pl-10 pr-4 py-2 bg-zinc-100 dark:bg-zinc-800 border border-zinc-700 rounded-lg focus:ring-2 focus:ring-gold outline-none text-sm font-bold text-zinc-900 dark:text-white"
            ...
            <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-xl border border-gold/10 overflow-hidden">
                <div className="p-6 border-b border-zinc-800 flex justify-between items-center bg-zinc-100 dark:bg-zinc-800/30">
                    <h3 className="font-black text-gold uppercase tracking-widest flex items-center gap-2 font-luxury text-sm">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        <thead className="bg-zinc-100 dark:bg-zinc-800/50 uppercase text-[10px] font-black text-zinc-500">
                            <tr>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-md border border-gold/20">
            <div className="p-6 border-b border-zinc-800 flex justify-between items-center">
                ...
                <button onClick={() => setIsInitialCashModalOpen(false)} className="p-2 hover:bg-zinc-100 dark:bg-zinc-800 rounded-full text-zinc-400 transition-colors"><X size={20}/></button>
            </div>
          ...
          <div className="bg-white dark:bg-zinc-900 rounded-2xl shadow-2xl w-full max-w-md border border-gold/20">
            ...
            <form onSubmit={handleCreateExpense} className="p-6 space-y-4">
                <div>
                    ...
                    <input 
                        type="number" 
                        className="w-full p-4 bg-zinc-100 dark:bg-zinc-800 border-2 border-zinc-700 rounded-xl outline-none focus:border-red-500 font-black text-2xl text-red-400 shadow-inner"
                ...
                <div>
                    ...
                    <input 
                        type="text" 
                        className="w-full p-3 bg-zinc-100 dark:bg-zinc-800 border-2 border-zinc-700 rounded-xl outline-none focus:border-gold text-zinc-900 dark:text-white font-bold"
                ...
                <div>
                    ...
                    <textarea 
                        className="w-full p-3 bg-zinc-100 dark:bg-zinc-800 border-2 border-zinc-700 rounded-xl outline-none focus:border-gold text-zinc-900 dark:text-white font-medium min-h-[100px]"
                ...
                <button type="submit" className="w-full py-4 bg-red-600 text-zinc-900 dark:text-white rounded-xl font-black uppercase tracking-widest hover:bg-red-700 shadow-xl transition-all transform active:scale-95 mt-2">
                    CONFIRMER LA SORTIE
                </button>
            </form>
          </div>
